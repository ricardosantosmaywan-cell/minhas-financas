                              ...
                              <div className="flex items-center space-x-4">
                                ...
                                <div>
                                  ...
                                  <p className={t.isCritical ? 'text-rose-400 font-bold text-xs' : 'text-yellow-500/80 text-xs'}>
                                    {t.accountName ? <span className="font-semibold">Conta: {t.accountName} • </span> : ''}{t.date}
                                  </p>
                                </div>
                              </div>
                       ...
                       <div className="flex items-center space-x-4">
                         ...
                         <div>
                           ...
                           <p className="text-yellow-500/80 text-xs">
                             {t.accountName ? <span className="font-semibold">Conta: {t.accountName} • </span> : ''}Vence: {t.date}
                           </p>
                         </div>
                       </div>
